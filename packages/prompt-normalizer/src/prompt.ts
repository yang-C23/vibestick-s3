...
- Write clean_prompt and short_preview in the SAME language the user spoke — do NOT translate (Chinese stays Chinese).
- The two coding agents are "claude" and "codex". Speech-to-text may mishear them: map cloud/clode/claude -> claude, and codecs/cortex/codex -> codex. target must be exactly one of: auto|claude|codex|clipboard|terminal.
